package dev.langchain4j.microprofile.plugin;

import static dev.langchain4j.microprofile.config.spi.LLMConfig.PRODUCER;
...
import dev.langchain4j.microprofile.config.spi.LLMConfigProvider;
import dev.langchain4j.microprofile.config.spi.ProducerFunction;
